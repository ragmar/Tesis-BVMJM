...
<div class='book view'>
	...
	<br />
		<div style="width: 100%; text-align: center;">
			<?php
// 					echo 'http://' . $_SERVER['HTTP_HOST'] .$this->base."/app/webroot/covers/" . $item['Item']['cover_path'];
					if (($item['Item']['cover_name']) && (file_exists('http://' . $_SERVER['HTTP_HOST'] . "/".$this->base."app/webroot/covers/" . $item['Item']['cover_path']))){
