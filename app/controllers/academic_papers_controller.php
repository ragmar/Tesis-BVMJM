...
class AcademicPapersController extends AppController {
	...
	function index() {
		if (!empty($this->data)) {
			$conditions =  array('OR' => array(array('Item.h-006' => 't', 'Item.h-007' => 'a', 'Item.published' => '1','Item.type'  => '0'), //||
			array('Item.h-006' => 't', 'Item.h-007' => 'b', 'Item.published' => '1','Item.type'  => '0'), 
			array('Item.h-006' => 't', 'Item.h-007' => 'm', 'Item.published' => '1', 'Item.type'  => '0')));
		...
		$conditions = array('OR' => array(array('Item.h-006' => 't', 'Item.h-007' => 'm', 'Item.published' => '1','Item.type'  => '0'), //||
		array('Item.h-006' => 't', 'Item.h-007' => 'b', 'Item.published' => '1', 'Item.type'  => '0'), array('Item.h-006' => 't', 'Item.h-007' => 'm', 'Item.published' => '1',  'Item.type'  => '0')));
		}
	...
	function century($century = null) {
		$conditions =array('OR' => array(array('Item.h-006' => 'k', 'Item.h-007' => 'a', 'Item.published' => '1', 'Item.type'  => '0'), //||
		array('Item.h-006' => 'k', 'Item.h-007' => 'b', 'Item.published' => '1',  'Item.type'  => '0'), array('Item.h-006' => 'k', 'Item.h-007' => 'm', 'Item.published' => '1', 'Item.type'  => '0')));
	...
	function add() {
		...
		if (!empty($this->data)) {
			...
			if ($_FILES['data']['error']['AcademicPaper']['item'] == 0){
				...
				$fileName = $data['AcademicPaper']['item_file_path'];
