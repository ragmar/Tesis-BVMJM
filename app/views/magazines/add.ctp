...
<table class="table">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Procedencia.</td>
		<td><?php echo $this->Form->input('561a', array('id' => '561a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '3')); ?></td>
	</tr>
	<tr>
		<td><b>$u</b></td>
		<td>Identificador Uniforme del Recurso.</td>
		<td><?php echo $this->Form->input('561u', array('id' => '561u', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '3')); ?></td>
	</tr>
</table>
...
$(document).ready(function() {
	...
	$("#653i1, #653i2, #653a").bind('keyup change', function(event) {
		var tmp_653 = "";
	...
	$('#MagazineAddForm').submit(function(event) {
		//alert($("#fecha008-07-10").prop("disabled"));
		//alert($("#fecha008-07-10").val().length < 4);
