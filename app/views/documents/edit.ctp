...
<li><a href="<?php echo $this->base; ?>/configurations">Inicio</a></li>
 <li><a href="<?php echo $this->base; ?>/documents">Documentos</a></li>
							...
							if (($c0080710_1 == '#') || ($c0080710_1 == 'u')) { // Caso 2 y 3. 
								...
								if ((substr($c008, 8, 1) != '|') && (substr($c008, 8, 1) != '#') && (substr($c008, 8, 1) != 'u')) {
									...
									if (substr($c008, 11, 1) == '|') {
										...
										$c0083537 = substr($c008, 15, 3);
									} else {
										$c0080710_3 = substr($c008, 8, 1);
										$c0081517 = substr($c008, 9, 3);
										$c0083537 = substr($c008, 12, 3);
									}
								}
							}
						?>
...
<table class="table">
	...
	<tr>
		...
		<?php
			if (isset($c520['b'])) {
				echo $this->Form->input('520b', array('id' => '520b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c520['b']));
			} else {
				echo $this->Form->input('520b', array('id' => '520b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('655i1', array('id' => '655i1', 'label' => false, 'div' => false, 'class' => 'form-control', 
			'options' => array(
				'#' => '# - Básico',
				'0' => '0 - Facetado'
			), 'selected' => substr($c655['indicators'], 0, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>I2</b></td>
		...
		<td><?php echo $this->Form->input('655i2', array('id' => '655i2', 'label' => false, 'div' => false, 'class' => 'form-control',
			'options' => array(
				...
				'6' => '6 - Répertoire de vedettes-matière',
				'7' => '7 - Fuente especificada en el subcampo $2'
			), 'selected' => substr($c655['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
	...
	<tr>
		...
		<?php
		if(isset($c655['b'])) {
			echo $this->Form->input('655b', array('id' => '655b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c655['b']));
		} else {
			echo $this->Form->input('655b', array('id' => '655b', 'label' => false, 'div' => false, 'class' => 'form-control'));
		}
		?>
		</td>
	</tr>
	<tr>
		...
		<?php
		if(isset($c655['c'])) {
			echo $this->Form->input('655c', array('id' => '655c', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c655['c']));
		} else {
			echo $this->Form->input('655c', array('id' => '655c', 'label' => false, 'div' => false, 'class' => 'form-control'));
		}
		?>
		</td>
	</tr>
	<tr>
		...
		<?php
		if(isset($c655['v'])) {
			echo $this->Form->input('655v', array('id' => '655v', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c655['v']));
		} else {
			echo $this->Form->input('655v', array('id' => '655v', 'label' => false, 'div' => false, 'class' => 'form-control'));
		}
		?>
		</td>
	</tr>
	<tr>
		...
		<?php
		if(isset($c655['x'])) {
			echo $this->Form->input('655x', array('id' => '655x', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c655['x']));
		} else {
			echo $this->Form->input('655x', array('id' => '655x', 'label' => false, 'div' => false, 'class' => 'form-control'));
		}
		?>
		</td>
	</tr>
	<tr>
		...
		<?php
		if(isset($c655['y'])) {
			echo $this->Form->input('655y', array('id' => '655y', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c655['y']));
		} else {
			echo $this->Form->input('655y', array('id' => '655y', 'label' => false, 'div' => false, 'class' => 'form-control'));
		}
		?>
		</td>
	</tr>
	<tr>
		...
		<?php
		if(isset($c655['z'])) {
			echo $this->Form->input('655z', array('id' => '655z', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c655['z']));
		} else {
			echo $this->Form->input('655z', array('id' => '655z', 'label' => false, 'div' => false, 'class' => 'form-control'));
		}
		?>
		</td>
	</tr>
