...
<?php echo $this->Form->create('Book'); ?>
	...
	<table class="table">
		...
		<tr>
			<th style="width: 10%">490</th>
			<th style="width: 45%">Mención de serie.</th>
			<td style="width: 45%"><?php echo $this->Form->input('490', array('id' => '490', 'label' => false, 'class' => 'form-control', 'div' => false)); ?></td>
		</tr>
		<tr>
