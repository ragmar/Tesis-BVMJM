		...
		<td>
			<table id="008pf">
				<tr>
					...
					<td>
						<?php echo $this->Form->input('fecha1-008-07-10', array('id' => 'fecha008-07-10', 'label' => false, 'class' => 'form-control', 'div' => false, 'maxlength' => '4', 'placeholder' => 'yyyy', 'disabled' => 'disabled')); ?>
					</td>
				</tr>
			</table>
		</td>
		...
		<td>
			<table id="008sf">
				<tr>
					...
					<td>
						<?php echo $this->Form->input('fecha2-008-11-14', array('id' => 'fecha008-11-14', 'label' => false, 'class' => 'form-control', 'div' => false, 'maxlength' => '4', 'placeholder' => 'yyyy', 'disabled' => 'disabled')); ?>
					</td>
				</tr>
			</table>
		</td>
...
<table class="table">
	<tr>
		...
		<th style="width: 45%;">
			...
			<?php echo $this->Form->hidden('040', array('id' => '040', 'label' => false, 'div' => false, 'value' => 'BVMJM')); ?>
		</th>
	</tr>
	<tr>
		<td><b>$a</b></td>
		<td>Centro catalogador de origen.</td>
		<td><?php echo $this->Form->input('040a', array('id' => '040a', 'label' => false, 'div' => false, 'value' => 'BVMJM', 'class' => 'form-control')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('041a', array('id' => '041a', 'label' => false, 'class' => 'form-control', 'div' => false,
			'options' => array(
				'aar' => 'Afar',
				'abk' => 'Abkhaz',
				'ace' => 'Achinese',
		...
		<script type="text/javascript">
			// Se ordena la lista.
			$("#041a").append($("#041a option").remove().sort(function(a, b) {
			    var at = $(a).text(), bt = $(b).text();
			    return (at > bt)?1:((at < bt)?-1:0);
			}));
			$('#041a').val('spa');
...
<table class="table">
	...
	<tr>
		<td><b>$b</b></td>
		<td>Numeración.</td>
		<td><?php echo $this->Form->input('100b', array('id' => '100b', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$d</b></td>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('245f', array('id' => '245f', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$g</b></td>
		<td>Fechas predominantes.</td>
		<td><?php echo $this->Form->input('245g', array('id' => '245g', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$h</b></td>
	...
	<tr>
		<td><b>$k</b></td>
		<td>Forma.</td>
		<td><?php echo $this->Form->input('245k', array('id' => '245k', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$n</b></td>
		<td>Número de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('245n', array('id' => '245n', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$p</b></td>
		<td>Nombre de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('245p', array('id' => '245p', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$s</b></td>
		<td>Versión.</td>
		<td><?php echo $this->Form->input('245s', array('id' => '245s', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
</table>
...
<table class="table">
	<tr>
		<th style="width: 10%;"><b>490</b></th>
		<th style="width: 45%;"><b>Mención de serie.</b></th>
		<th style="width: 45%;">
	...
	<tr>
		<td><b>$l</b></td>
		<td>Signatura topográfica de la Biblioteca del Congreso.</td>
		<td><?php echo $this->Form->input('490l', array('id' => '490l', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$v</b></td>
		<td>Designación de volumen o secuencia.</td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('490x', array('id' => '490x', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
</table>
</div>
...
<table class="table">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Nota general.</td>
		<td><?php echo $this->Form->input('500a', array('id' => '500a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Con.</td>
		<td><?php echo $this->Form->input('501a', array('id' => '501a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		<td><b>$b</b></td>
		<td>Número de referencias.</td>
		<td><?php echo $this->Form->input('504b', array('id' => '504b', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('505a', array('id' => '505a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('510a', array('id' => '510a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Localización dentro de la fuente.</td>
		<td><?php echo $this->Form->input('510c', array('id' => '510c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table" style="display: none;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('515a', array('id' => '515a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		<td><b>$a</b></td>
		<td>Sumario, etc.</td>
		<td><?php echo $this->Form->input('520a', array('id' => '520a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table" style="display: none;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('530a', array('id' => '530a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Condiciones de adquisición.</td>
		<td><?php echo $this->Form->input('530c', array('id' => '530c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$u</b></td>
		<td>Dirección electrónica.</td>
		<td><?php echo $this->Form->input('530u', array('id' => '530u', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('534a', array('id' => '534a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Mención de edición del original.</td>
		<td><?php echo $this->Form->input('534b', array('id' => '534b', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Publicación, distribución, etc. del original.</td>
		<td><?php echo $this->Form->input('534c', array('id' => '534c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$e</b></td>
		<td>Descripción física, etc. del original.</td>
		<td><?php echo $this->Form->input('534e', array('id' => '534e', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$p</b></td>
		<td>Frase introductoria.</td>
		<td><?php echo $this->Form->input('534p', array('id' => '534p', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$t</b></td>
		<td>Mención de título del original.</td>
		<td><?php echo $this->Form->input('534t', array('id' => '534t', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('546a', array('id' => '546a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
		<td>Información sobre el código o alfabeto.</td>
		<td><?php echo $this->Form->input('546c', array('id' => '546c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table" style="display: none;">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('555a', array('id' => '555a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$b</b></td>
		<td>Fuente de la adquisición.</td>
		<td><?php echo $this->Form->input('555b', array('id' => '555b', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$d</b></td>
		<td>Referencia bibliográfica.</td>
		<td><?php echo $this->Form->input('555d', array('id' => '555d', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
	<tr>
		<td><b>$u</b></td>
		<td>Dirección electrónica.</td>
		<td><?php echo $this->Form->input('555u', array('id' => '555u', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('561u', array('id' => '561u', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
</table>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('588a', array('id' => '588a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2')); ?></td>
	</tr>
</table>
</div>
...
<table class="table">
	...
	<tr>
		<td><b>$b</b></td>
		<td>Numeración.</td>
		<td><?php echo $this->Form->input('600b', array('id' => '600b', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$c</b></td>
...
<table class="table">
	...
	<tr>
		...
		<td><?php echo $this->Form->input('710c', array('id' => '710c', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$d</b></td>
		<td>Fecha del congreso o de la firma de un tratado.</td>
		<td><?php echo $this->Form->input('710d', array('id' => '710d', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$e</b></td>
		<td>Término indicativo de función.</td>
	...
	<tr>
		...
		<td><?php echo $this->Form->input('710f', array('id' => '710f', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$g</b></td>
		<td>Información miscelánea.</td>
		<td><?php echo $this->Form->input('710g', array('id' => '710g', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$h</b></td>
		<td>Tipo de material.</td>
		<td><?php echo $this->Form->input('710h', array('id' => '710h', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$i</b></td>
		<td>Información sobre la relación.</td>
		<td><?php echo $this->Form->input('710i', array('id' => '710i', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$k</b></td>
		<td>Subencabezamiento de forma.</td>
		<td><?php echo $this->Form->input('710k', array('id' => '710k', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$l</b></td>
		<td>Lengua de la obra.</td>
		<td><?php echo $this->Form->input('710l', array('id' => '710l', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$m</b></td>
		<td>Medio de interpretación.</td>
		<td><?php echo $this->Form->input('710m', array('id' => '710m', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$n</b></td>
		<td>Número del congreso o número de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('710n', array('id' => '710n', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$o</b></td>
		<td>Arreglo.</td>
		<td><?php echo $this->Form->input('710o', array('id' => '710o', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$p</b></td>
		<td>Nombre de parte o sección de la obra.</td>
		<td><?php echo $this->Form->input('710p', array('id' => '710p', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$r</b></td>
		<td>Tonalidad.</td>
		<td><?php echo $this->Form->input('710r', array('id' => '710r', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$s</b></td>
		<td>Versión.</td>
		<td><?php echo $this->Form->input('710s', array('id' => '710s', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$t</b></td>
		<td>Título de la obra.</td>
	...
	<tr>
		<td><b>$u</b></td>
		<td>Filiación.</td>
		<td><?php echo $this->Form->input('710u', array('id' => '710u', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
	<tr>
		<td><b>$x</b></td>
		<td>Número Internacional Normalizado para Publicaciones Seriadas (ISSN).</td>
		<td><?php echo $this->Form->input('710x', array('id' => '710x', 'label' => false, 'div' => false, 'class' => 'form-control')); ?></td>
	</tr>
</table>
...
$(document).ready(function() {
	...
	$("#041i1, #041i2, #041a, #041b, #041h").bind('keyup change', function(event) {
		tmp_041 = "";
		if ($('#041a').val().length > 0) {
			tmp_041 = tmp_041 + '^a' + $('#041a').val();
		}
	...
	$("#490i1, #490i2, #490a, #490l, #490v, #490x").bind('keyup change', function(event) {
		var tmp_490 = "";
		...
		if ($('#490l').val().length > 0) {
			tmp_490 = tmp_490 + '^l' + $('#490l').val();
		}
		...
		if ($('#490x').val().length > 0) {
			tmp_490 = tmp_490 + '^x' + $('#490x').val();
		}
		
		if (tmp_490.length > 0) {
			$("#490").val($("#490i1").val() + $("#490i2").val() + tmp_490);
			$("#l-490").html($("#490i1").val() + $("#490i2").val() + tmp_490);
		} else {
			$("#490").val('');
			$("#l-490").html('&nbsp;');
		}
	...
	$("#504a, #504b").bind('keyup change', function(event) {
		var tmp_504 = "";
		...
		if ($('#504b').val().length > 0) {
			tmp_504 = tmp_504 + '^b' + $('#504b').val();
		}
	...
	$("#561a, #561u").bind('keyup change', function(event) {
		var tmp_561 = "";
	...
	$("#800i1, #800i2, #800a, #800d, #800t").bind('keyup change', function(event) {
		var tmp_800 = "";
