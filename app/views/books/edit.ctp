...
<?php $c490 = marc21_decode($item['Item']['490']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>490</b></th>
		<th style="width: 45%;"><b>Mención de serie.</b></th>
		<th style="width: 45%;">
			<label id="l-490"><?php echo $item['Item']['490']; ?></label>
			<?php echo $this->Form->hidden('490', array('id' => '490', 'label' => false, 'div' => false, 'value' => $item['Item']['490'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>I1</b></td>
		...
		<td><?php echo $this->Form->input('490i1', array('id' => '490i1', 'label' => false, 'div' => false, 'class' => 'form-control',
			...
			), 'selected' => substr($c490['indicators'], 0, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>I2</b></td>
		...
		<td><?php echo $this->Form->input('490i2', array('id' => '490i2', 'label' => false, 'div' => false, 'class' => 'form-control', 
			'options' => array(
				'#' => '# - No definido'		
			), 'selected' => substr($c490['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c490['a'])) {
				echo $this->Form->input('490a', array('id' => '490a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c490['a']));
			} else {
				echo $this->Form->input('490a', array('id' => '490a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c490['l'])) {
				echo $this->Form->input('490l', array('id' => '490l', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c490['l']));
			} else {
				echo $this->Form->input('490l', array('id' => '490l', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c490['v'])) {
				echo $this->Form->input('490v', array('id' => '490v', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c490['v']));
			} else {
				echo $this->Form->input('490v', array('id' => '490v', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c490['x'])) {
				echo $this->Form->input('490x', array('id' => '490x', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c490['x']));
			} else {
				echo $this->Form->input('490x', array('id' => '490x', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c500['a'])) {
				echo $this->Form->input('500a', array('id' => '500a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c500['a']));
			} else {
				echo $this->Form->input('500a', array('id' => '500a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c501['a'])) {
				echo $this->Form->input('501a', array('id' => '501a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c501['a']));
			} else {
				echo $this->Form->input('501a', array('id' => '501a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c504['b'])) {
				echo $this->Form->input('504b', array('id' => '504b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c504['b']));
			} else {
				echo $this->Form->input('504b', array('id' => '504b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c505['a'])) {
				echo $this->Form->input('505a', array('id' => '505a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c505['a']));
			} else {
				echo $this->Form->input('505a', array('id' => '505a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c510['a'])) {
				echo $this->Form->input('510a', array('id' => '510a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c510['a']));
			} else {
				echo $this->Form->input('510a', array('id' => '510a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c510['c'])) {
				echo $this->Form->input('510c', array('id' => '510c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c510['c']));
			} else {
				echo $this->Form->input('510c', array('id' => '510c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table" style="display: none;">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c515['a'])) {
				echo $this->Form->input('515a', array('id' => '515a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c515['a']));
			} else {
				echo $this->Form->input('515a', array('id' => '515a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c520['a'])) {
				echo $this->Form->input('520a', array('id' => '520a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c520['a']));
			} else {
				echo $this->Form->input('520a', array('id' => '520a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table" style="display: none;">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c530['a'])) {
				echo $this->Form->input('530a', array('id' => '530a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c530['a']));
			} else {
				echo $this->Form->input('530a', array('id' => '530a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c530['c'])) {
				echo $this->Form->input('530c', array('id' => '530c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c530['c']));
			} else {
				echo $this->Form->input('530c', array('id' => '530c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c530['u'])) {
				echo $this->Form->input('530u', array('id' => '530u', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c530['u']));
			} else {
				echo $this->Form->input('530u', array('id' => '530u', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c546['a'])) {
				echo $this->Form->input('546a', array('id' => '546a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c546['a']));
			} else {
				echo $this->Form->input('546a', array('id' => '546a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c546['c'])) {
				echo $this->Form->input('546c', array('id' => '546c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c546['c']));
			} else {
				echo $this->Form->input('546c', array('id' => '546c', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table" style="display: none;">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c555['a'])) {
				echo $this->Form->input('555a', array('id' => '555a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c555['a']));
			} else {
				echo $this->Form->input('555a', array('id' => '555a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c555['b'])) {
				echo $this->Form->input('555b', array('id' => '555b', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c555['b']));
			} else {
				echo $this->Form->input('555b', array('id' => '555b', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c555['d'])) {
				echo $this->Form->input('555d', array('id' => '555d', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c555['d']));
			} else {
				echo $this->Form->input('555d', array('id' => '555d', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c555['u'])) {
				echo $this->Form->input('555u', array('id' => '555u', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c555['u']));
			} else {
				echo $this->Form->input('555u', array('id' => '555u', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c561['u'])) {
				echo $this->Form->input('561u', array('id' => '561u', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c561['u']));
			} else {
				echo $this->Form->input('561u', array('id' => '561u', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c588['a'])) {
				echo $this->Form->input('588a', array('id' => '588a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2', 'value' => $c588['a']));
			} else {
				echo $this->Form->input('588a', array('id' => '588a', 'label' => false, 'div' => false, 'class' => 'form-control', 'type' => 'textarea', 'rows' => '2'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	<tr>
		...
		<th style="width: 45%;">
			<label id="l-800"><?php echo $item['Item']['800']; ?></label>
