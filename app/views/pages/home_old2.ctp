...
<div class="col-md-3 column">
	...
	<div style="width: 270px; overflow: auto; padding-right: 10px;">
		<p class="noticias_txt"; style="color: black"><br />
			<?php foreach ($news as $new) { ?>
				<strong style="width: 100px"><span class="noticias_tit"><?php echo $new['News']['title']; ?></span></strong><br />
				<?php echo $new['News']['content']; ?>
				<?php //echo $this->Html->image($new['News']['content'], array('title' => 'Haga click para ver la descripción de la noticia.','url' => array('controller' => 'pages', 'action' => 'news')));
				?>
				<br />
		...
		<p>
			<?php echo $this->Html->link('Leer más', '/pages/news/', array('class' => 'btn btn-primary')); ?>
		</p>
	</div>
</div>
