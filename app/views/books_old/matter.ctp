...
<ul class="breadcrumb" style="margin: 0">
  ...
  <li>Materia<span class="divider">/</span></li>
  <?php } else { ?>
  <li><a href="<?php echo $this->base; ?>/books/matter">Materia</a><span class="divider">/</span></li>
  <li class="active"><?php echo $topics[$this->passedArgs[0]]; ?></li>
  <?php } ?>
</ul>
...
<table style="font-size: smaller; width: 75%;">
	<tr>
		...
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smrevistas_s2.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/matter">Materia</a></td>
	</tr>
</table>
</div>
...
<div class="actions">
	<br />
	<ul>
		<li><label><?php __('Revistas de la Materia:'); ?></label></li>
		<?php foreach ($topics as $t => $v): ?>
		<li><?php echo $this->Html->link(__($v, true), array('action' => 'matter/'.$t)); ?></li>
		<?php endforeach; ?>
		<!--
