...
<ul class="breadcrumb" style="margin: 0">
  ...
  <?php } else { ?>
  <li><a href="<?php echo $this->base; ?>/books/century">Siglo</a><span class="divider">/</span></li>
...
<table style="font-size: smaller; width: 75%;">
	<tr>
		...
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smrevistas_s2.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/century">Siglo</a></td>
...
<!-- 
	...
	<tr>
		...
		<?php if (!empty($item['ItemsPicture']) && (is_file("/webroot/attachments/files/big/" . $item['ItemsPicture'][0]['picture_file_path']))) { ?>
...
<div class="actions">
	<br />
	<ul>
		<li><label><?php __('Revistas del Siglo:'); ?></label></li>
		<?php foreach ($centuries as $c): ?>
		<li><?php echo $this->Html->link(__($c, true), array('action' => 'century/'.$c)); ?></li>
		<?php endforeach; ?>
		<!--
