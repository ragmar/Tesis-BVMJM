...
<ul class="breadcrumb" style="margin: 0">
  ...
  <?php } else { ?>
  <li><a href="<?php echo $this->base; ?>/books/year">A&ntilde;o</a><span class="divider">/</span></li>
...
<table style="font-size: smaller; width: 75%;">
	<tr>
		...
		<td width="100px" valign="middle" style="text-align:center; background-image: url('<?php echo $this->base; ?>/img/ts/fondo_boton_smrevistas_s2.jpg'); background-repeat: no-repeat;"><a href="<?php echo $this->base; ?>/books/year">Año</a></td>
...
<div class="actions">
	<br />
	<ul>
		<li><label><?php __('Revistas del Año:'); ?></label></li>
		
		<?php foreach ($years as $y){ ?>
		<li><?php echo $this->Html->link($y['Item']['year'], array('action' => 'year/' . $y['Item']['year'])); ?></li>
		<?php } ?>
