...
<br />
<?php echo $this->Form->input('title', array('label' => 'Titulo de la Obra', 'style' => 'width: 50%')); ?>
	<div style="float: left; width: 100%">
		<div style="float: left; width: 50%; text-align: right;">
			<?php echo $this->Form->input('author_id', array('div' => false, 'empty' => __('Author', true), 'label' => false)); ?>
			&nbsp;
		</div>
		<div style="float: left; width: 50%; text-align: left;">
			&nbsp;
			<?php echo $this->Form->input('type_id', array('div' => false, 'empty' => __('Type', true), 'label' => false)); ?>
		</div>
		<div style="float: left; width: 50%; text-align: right;">
			<?php echo $this->Form->input('topic_id', array('div' => false, 'empty' => __('Topic', true), 'label' => false)); ?>
			&nbsp;
		</div>
		<div style="float: left; width: 50%; text-align: left;">
			&nbsp;
			<?php echo $this->Form->year('year', 1700, date('Y'), null, array('div' => false, 'label' => false, 'empty' => __('Year', true))); ?>
		</div>
	</div>
	<?php
		/*
