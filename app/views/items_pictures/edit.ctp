...
<div class="itemsIndicators form">
<?php echo $this->Form->create('ItemsIndicator');?>
	<fieldset>
		<legend><?php __('Edit Items Indicator'); ?></legend>
	<?php
...
<div class="actions">
	...
	<br />
	<ul>
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ItemsIndicator.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ItemsIndicator.id'))); ?></li>
