...
<table class="table">
	...
	<tr>
		...
		<td><?php
			if (isset($c502['b'])) {
				echo $this->Form->input('502b', array('id' => '502b', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c502['b']));
			} else {
				echo $this->Form->input('502b', array('id' => '502b', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td><?php
			if (isset($c502['c'])) {
				echo $this->Form->input('502c', array('id' => '502c', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c502['c']));
			} else {
				echo $this->Form->input('502c', array('id' => '502c', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td><?php
			if (isset($c502['d'])) {
				echo $this->Form->input('502d', array('id' => '502d', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c502['d']));
			} else {
				echo $this->Form->input('502d', array('id' => '502d', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	...
	<tr>
		...
		<td><?php
			if (isset($c648['0'])) {
				echo $this->Form->input('6480', array('id' => '6480', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c648['0']));
			} else {
				echo $this->Form->input('6480', array('id' => '6480', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?></td>
	</tr>
	<tr>
		...
		<td><?php
			if (isset($c648['2'])) {
				echo $this->Form->input('6482', array('id' => '6482', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c648['2']));
			} else {
				echo $this->Form->input('6482', array('id' => '6482', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?></td>
	</tr>
	<tr>
		...
		<td><?php
			if (isset($c648['3'])) {
				echo $this->Form->input('6483', array('id' => '6483', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c648['3']));
			} else {
				echo $this->Form->input('6483', array('id' => '6483', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?></td>
	</tr>
	<tr>
		...
		<td><?php
			if (isset($c648['6'])) {
				echo $this->Form->input('6486', array('id' => '6486', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c648['6']));
			} else {
				echo $this->Form->input('6486', array('id' => '6486', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?></td>
	</tr>
	<tr>
		...
		<td><?php
			if (isset($c648['8'])) {
				echo $this->Form->input('6488', array('id' => '6488', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c648['8']));
			} else {
				echo $this->Form->input('6488', array('id' => '6488', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?></td>
	</tr>
</table>
...
<?php echo $this->Form->hidden('user_id', array('value' => $this->Session->read('Auth.User.id'))); ?>
	...
	<input type="checkbox" id="AcademicPaperPublished" value="1" checked="checked" name="data[AcademicPaper][published]" style="width: 30px; dis">Publicado
	</div>
