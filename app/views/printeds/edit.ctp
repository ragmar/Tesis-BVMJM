...
<?php echo $this->Form->create('Printed', array('enctype' => 'multipart/form-data')); ?>
...
<?php $c024 = marc21_decode($item['Item']['024']); ?>
<table class="table">
	<tr>
		<th style="width: 10%;"><b>024</b></th>
		<th style="width: 45%;"><b>Otros identificadores normalizados (ISMN).</b></th>
		<th style="width: 45%;">
			<label id="l-024"><?php echo $item['Item']['024']; ?></label>
			<?php echo $this->Form->hidden('024', array('id' => '024', 'label' => false, 'div' => false, 'value' => $item['Item']['024'])); ?>
		</th>
	</tr>
		<tr>
		<td><b>I1</b></td>
		...
		<td><?php echo $this->Form->input('024i1', array('id' => '024i1', 'label' => false, 'div' => false, 'class' => 'form-control',
			...
			), 'selected' => substr($c024['indicators'], 0, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>I2</b></td>
		...
		<td><?php echo $this->Form->input('024i2', array('id' => '024i2', 'label' => false, 'div' => false, 'class' => 'form-control',
			'options' => array(
					...
					'1'=> '1 - Hay diferencia '
			), 'selected' => substr($c024['indicators'], 1, 1)
		)); ?></td>
	</tr>
	<tr>
		<td><b>$a</b></td>
		...
		<td>
			<?php
			if (isset($c024['a'])) {
				echo $this->Form->input('024a', array('id' => '024a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c024['a']));
			} else {
				echo $this->Form->input('024a', array('id' => '024a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c024['b'])) {
				echo $this->Form->input('024y', array('id' => '024y', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c024['y']));
			} else {
				echo $this->Form->input('024y', array('id' => '024y', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<table class="table">
	<tr>
		...
		<th style="width: 45%;"><b>Política de recuperación de series.</b></th>
		<th style="width: 45%;">
...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c505['a'])) {
				echo $this->Form->input('505t', array('id' => '505t', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c505['t']));
			} else {
				echo $this->Form->input('505t', array('id' => '505t', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c505['r'])) {
				echo $this->Form->input('505r', array('id' => '505r', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c505['r']));
			} else {
				echo $this->Form->input('505r', array('id' => '505r', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php echo $this->Form->hidden('user_id', array('value' => $this->Session->read('Auth.User.id'))); ?>
	...
	<input type="checkbox" id="PrintedPublished" value="1" checked="checked" name="data[Printed][published]" style="width: 30px;">Publicado
...
$("#592b").bind('keyup change', function(event) {
	...
	$('#PrintedAddForm').submit(function(event) {
	/*	if ($('#031t').val() == ""){
