...
<ul class="breadcrumb" style="margin: 0">
  ...
  <?php if (!isset($this->passedArgs[0])) { ?>
  	<li>Tonalidad</li>
  <?php } else { ?>
  	<li><a href="<?php echo $this->base; ?>/manuscripts/hue">Tonalidad</a></li>
...
<div class='year view'>
	...
	<?php } else { ?>
		<br />
		<p>No hay partituras para esta tonalidad.</p>
		<br /><br /><br /><br /><br />
	<?php } ?>
...
<div class="col-md-3 column">
	<br />
	<label><?php __('Tonalidades:'); ?></label>
	<?php
		//foreach ($hues as $h){
			echo $this->Html->link($h, array('action' => 'hue/' . $h), array('class' => 'btn-primary'));
		//}
		echo $this->Html->link(__('Todas', true), array('action' => 'hue/'), array('class' => 'btn-primary'));
	?>
